...
//         (selectedInsuranceId === "" || guide.insurance_id.toString() === selectedInsuranceId) && /* tratamento de error, condicoes e verificacao */
...
//             <td>${guide.number}</td>
//             <td class="text-ellipsis" title="${guide.patient.name}"> 
//                 <img class="patient-img" src="${guide.patient.thumb_url || 'https://via.placeholder.com/150x150.jpg'}" alt="${guide.patient.name}">
//                 ${guide.patient.name}
//             </td>
